...
def main():
    ...
    zg0 = np.linspace(0, map_shifted.z_size(), num=map_shifted.z_size(), endpoint=False)
    yg0 = np.linspace(0, map_shifted.y_size(), num=map_shifted.y_size(), endpoint=False)
    xg0 = np.linspace(0, map_shifted.x_size(), num=map_shifted.x_size(), endpoint=False)
    ...
    for cycrr in range(0, ncycrr):
        ...
        for cyc in range(0, ncyc):
            ...
            cmap = mapin_tgt.downsample_map(spacing, downsamp_shape)
